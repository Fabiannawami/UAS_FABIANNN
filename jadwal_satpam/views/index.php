...
<html lang="en">
    ...
    <body class="bg-primary">
        <div class="container">
            ...
            <h1 class="mt-4 mb-4 text-center text-white">Data Jadwal Satpam</h1>
            <span id="message"></span>
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col col-sm-9">Data Jadwal Satpam</div>
                ...
                <div class="modal-content">
                    <form method="post" id="sample_form">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="action_button"id="action_button">Add</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event){
                ...
                if($('#action').val() == "Add"){
                    ...
                    $.ajax({
                        url:"http://localhost/jadwal_satpam/api/employee/create.php",
                        method:"POST",
                    ...
                    $.ajax({
                        url:"http://localhost/jadwal_satpam/api/employee/update.php",
                        method:"PUT",
                        data: JSON.stringify(formData),
                        success:function(data){
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                    ...
                    url: "http://localhost/jadwal_satpam/api/employee/read.php",
        ...
        function showOne(id) {
            ...
            $.ajax({
                    type: "GET",
                    contentType: "application/json",
                    url: "http://localhost/jadwal_satpam/api/employee/read.php?id="+id,
                    success: function(response) { 
                        $('#id').val(response.id);
        ...
        function deleteOne(id) {
            ...
            $.ajax({
                url:"http://localhost/jadwal_satpam/api/employee/delete.php",
                method:"DELETE",
